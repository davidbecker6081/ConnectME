...
export const fetchFriends = ({ userID, location }) => {
	return dispatch => {
		...
		fetch(
			'https://graph.facebook.com/v2.10/10152786482452059?fields=about,name,hometown,location,email,friends.limit(200){name,hometown,location,about,picture{url}}&access_token=EAACEdEose0cBAFc1QjjT3Br99WVEvdXFeZB4ZAITX3NSEqHTWKb3c0HIQ0esiPrNmfV9zo0p0UzZCdaq2JRSrEnaMK69MBZBqmWeRb2ZATSSMgMYQciH4l94yss7cfhZA6HTDYoZBgzEZASJTdav6j475ZBZAZCdXLoaZCgphSAcAkQ53FECNKNHlUzyUrkWh14dT6AZD'
		)
			.then(response => {
