...
export const fetchFriends = ({ userID, location }) => {
	return dispatch => {
		...
		fetch(
			'https://graph.facebook.com/v2.10/10152786482452059?fields=about,name,hometown,location,email,friends.limit(200){name,hometown,location,about,picture{url}}&access_token=EAACEdEose0cBAKax8UdNKFeZA6zhwtMNOGtbZCKO3ZAZBKI6m6smwZByZADSJ4rIRJk2UfX4yQWBZBdUl0apB43wCNBFomBNwk9TExPZCxygczlGogLt8Xs2iYQ5bhOsVm6fcXQ1yEspZCQq60OIGziFTt9UZAcSomsCaHCk0nPR0hdLtS7vOucusTGwoHJBnj6nAZD'
		)
			.then(response => {
