...
export const fetchFriends = ({ userID, location }) => {
	return dispatch => {
		...
		fetch(
			'https://graph.facebook.com/v2.10/10152786482452059?fields=about,name,hometown,location,email,friends.limit(200){name,hometown,location,about,picture{url}}&access_token=EAACEdEose0cBAMzKVBv5TF3jOZCwZCaV6qMqiNa6MZAdqnPGTl9GpkqaIvahtZBcTRq5cyKe908QGw7swPkWFa1KgvqZB2UQTmFz2LWcGn3VeVZCZBDZCUoH9mZA53kDjVGXDMPaSsHqAZCyck5YLEnIz50eEiTepaZCHAwUOseesjm7wn5ezxGfqPXBZBKP7otHJdsZD'
		)
			.then(response => {
