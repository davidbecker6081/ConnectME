...
export const fetchFriends = userID => {
	return dispatch => {
		...
		fetch(
			'https://graph.facebook.com/v2.10/10152786482452059?fields=about,name,hometown,location,email,friends{name,hometown,location,about,picture{url}}&access_token=EAACEdEose0cBAEv1x7kYetlfAmXEZCLvI48JPLvDY8UWkHx7AomEFHuRi2UPZBUoaCBZCGmX2YL8oTrJbZB2ab0cW7YZBPxvQsbGd0oNcGTBAgUi2fHD5ZCj1wMoXzM0k3u66dibFL9Tf6MUhLArcZCvNYwrBNsxGXx1E6bNRWEhSCzKDYMGdvzfRiDIyiOA5gZD'
		)
			.then(response => {
