...
export const fetchFriends = ({ userID, location }) => {
	return dispatch => {
		...
		fetch(
			'https://graph.facebook.com/v2.10/10152786482452059?fields=about,name,hometown,location,email,friends.limit(200){name,hometown,location,about,picture{url}}&access_token=EAACEdEose0cBAFXLmhdSWVvKszbrBcpontdK8ytS2J0lJpxY6ZCPfwHkuyOOglFTRlnmBdF3FRcl8jlWYWZCLZAhj1UD8KFaxySAARstPHoMVYCPSw9fQhmkpkX89oVM6VkkQqmhwNlfcUnNqzg5ttKI7oZCzqK8wtn19RmqRUZChWOPGeigGsbj5ZCANDVVfVIhvbjKv6rQZDZD'
		)
			.then(response => {
